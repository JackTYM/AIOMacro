...
public class AssLayer implements LayerRenderer<EntityPlayer> {
    private final RenderPlayer render;
    private final ModelRenderer model;

    public AssLayer(RenderPlayer render) {
        this.render = render;
    ...
    private void getTranslation(int size) {
        switch (size) {
            ...
            case 4:
                ...
                break;
            case 5:
                GlStateManager.translate(0.0F, 0.5F, 0.69F);
                break;
            case 6:
                GlStateManager.translate(0.0F, -0.59F, 0.69F);
                break;
            default:
                break;
        }
