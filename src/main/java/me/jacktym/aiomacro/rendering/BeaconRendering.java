...
public class BeaconRendering {


    public static HashMap<String, ArrayList<Integer>> beaconData = new HashMap<>();
    ...
    public static void renderBeaconBeam(double x, double y, double z, int rgb, float alphaMult, float partialTicks, Boolean disableDepth) {
        ...
        Main.mc.getTextureManager().bindTexture(new ResourceLocation("textures/entity/beacon_beam.png"));
        ...
        double time = Main.mcWorld.getTotalWorldTime() + (double) partialTicks;
